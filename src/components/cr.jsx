        ...
        <div>
            ...
            <div className="container">
                ...
                <div className="crs-cards">
                    <div class="card crs-card" style={{ marginLeft: '100px' }}>
                        <div class="card-body crs-card-body" style={{ padding: '40px' }}>
                            <h5 class="card-title">Maureen</h5>
                            <p class="card-subtitle mb-2 text-body-secondary" style={{ fontSize: '16px', marginTop: '15px' }}>08-12-2008</p>
                    ...
                    <div class="card crs-card">
                        <div class="card-body crs-card-body" style={{ padding: '40px' }}>
                            <h5 class="card-title">Erve Veldink</h5>
                            <p class="card-subtitle mb-2 text-body-secondary" style={{ fontSize: '16px', marginTop: '15px' }}>08-12-2008</p>
                            <div style={{ display: 'flex', marginTop: '20px', marginBottom: '20px' }}>
                                <img src={StarSvg} style={{ width: '20px' }} alt="card-star" />
                                <img src={StarSvg} style={{ width: '20px' }} alt="card-star" />
